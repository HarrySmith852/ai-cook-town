...
- Run:
```bash
node "${CLAUDE_PLUGIN_ROOT}/codex/scripts/codex-companion.mjs" review "$ARGUMENTS"
```
...
```typescript
Bash({
  command: `node "${CLAUDE_PLUGIN_ROOT}/codex/scripts/codex-companion.mjs" review "$ARGUMENTS"`,
